...
\large
\vspace{0.5 cm}
\uncover<4->{You will find bugs. Not all of them will be real. Ask me or a neighbor to take a look at it; if the problem isn't obvious, submit a bug report with a small test file.}
\end{frame}
...
\begin{tabular}{p{2 cm} p{11 cm}}
\parbox[c]{1.5 cm}{\includegraphics[width=1.5 cm]{safe.png}} & Feature is an essential part of the codebase; I designed around it and have included a formal test suite (build tests). \\
\parbox[c]{1.5 cm}{\includegraphics[width=1.5 cm]{caution.png}} & Uses same code paths as above and {\it informally} tested, but not yet integrated into the formal tests. \\
\parbox[c]{1.5 cm}{\includegraphics[width=1.5 cm]{danger.png}} & I wrote it for this talk and have only tested the examples shown in these slides. \\
\end{tabular}
